...
import com.yupi.onlineojbackendjudgeservice.judge.codesandbox.CodeSandBoxFactory;
import com.yupi.onlineojbackendjudgeservice.judge.strategy.JudgeContext;
import com.yupi.onlineojbackendjudgeservice.judge.strategy.JudgeManage;
...
public class JudgeServiceImpl implements JudgeService{
    ...
    public QuestionSubmit doJudge(Long questionSubmitId) {
        ...
        QuestionSubmit questionSubmitUpdate = questionFeignClient.getQuestionSubmitById(questionSubmitId);
//        questionSubmitUpdate.setId(questionSubmitId);
        questionSubmitUpdate.setStatus(QuestionSubmitEnum.RUNNING.getValue());
        boolean suc = questionFeignClient.updateQuestionSubmitById(questionSubmitUpdate);
        if(!suc){
...
//        questionSubmitUpdate = new QuestionSubmit();
        ...
        suc = questionFeignClient.updateQuestionSubmitById(questionSubmitUpdate);
        if(!suc){
            throw new BusinessException(ErrorCode.SYSTEM_ERROR,"题目提交状态更新失败");
        }
