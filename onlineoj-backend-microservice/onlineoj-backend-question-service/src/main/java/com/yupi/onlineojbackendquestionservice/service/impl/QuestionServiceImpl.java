...
import com.yupi.onlineojbackendquestionservice.mapper.QuestionMapper;
...
//    @Override
//    public Page<QuestionFeignClient> searchFromEs(QuestionQueryRequest questionQueryRequest) {
//        Long id = questionQueryRequest.getId();
...
//        Page<QuestionFeignClient> page = new Page<>();
//        page.setTotal(searchHits.getTotalHits());
//        List<QuestionFeignClient> resourceList = new ArrayList<>();
//        // 查出结果后，从 db 获取最新动态数据（比如点赞数）
//        if (searchHits.hasSearchHits()) {
//            List<SearchHit<QuestionEsDTO>> searchHitList = searchHits.getSearchHits();
//            List<Long> questionIdList = searchHitList.stream().map(searchHit -> searchHit.getContent().getId())
//                    .collect(Collectors.toList());
//            List<QuestionFeignClient> questionList = baseMapper.selectBatchIds(questionIdList);
//            if (questionList != null) {
//                Map<Long, List<QuestionFeignClient>> idQuestionMap = questionList.stream().collect(Collectors.groupingBy(QuestionFeignClient::getId));
